...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "paper-reader": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "Since Gemini returns the audio and nothing else, the app estimates timings to highlight the current sentence. Audio arrives as a list of 24,000 numbers for every second, so the total seconds in an audio clip can be calculated based on the total numbers in the list. At this point the app knows the total seconds but not how long each sentence takes. Highlight time per sentence is estimated by the character count of each sentence.",
      },
