  ...
  "paper-reader": {
    ...
    blocks: [
     ...
     // write to the level of my understanding
      ...
      {
        type: "text",
        text: "If I continued this project, I would integrate an API key into the app, minimize costs, and charge per paper. Asking users to set up their own key is the biggest pain point and its honestly a bad idea. There are many TTS products like Speechify that address similar problems, so I moved on.",
      },
