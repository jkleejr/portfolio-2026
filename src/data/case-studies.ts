  ...
  "buy-side-briefings": {
    ...
    blocks: [
     ...
     // current design
      ...
      {
        type: "text",
        text: "I think the current design is a good balance of information and simplicity. Reports used to be much longer but are now brief and always take less than 10 minutes to read. Since this website keeps a record of previous reports it would be interesting to use that to track sentiment trends of the over time."
      },
      // what to write here?
      //
