...
export const caseStudies: Record<string, CaseStudy> = {
  "loot-check": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "For most items, the value is based on the model's pre-trained data. If Claude is not sure, it does a web search to find the current value. I decided a web search wasn't necessary for every scan because it increased the cost by 3-4x, and Sonnet 4.6 is accurate enough for most things."
      },
