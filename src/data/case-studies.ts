...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "The core design work is in the instructions file in the repository. The file behaves as a living design system because every adjustment changes future reports. The agent writes the report following the rules and schema I gave it, like never fabricating information and always citing sources."
      },
