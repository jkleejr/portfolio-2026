...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "To understand why prices were moving, I used multiple platforms to analyze data. It was a fragmented workflow because of context switching and friction."
      },
