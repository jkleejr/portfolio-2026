...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "This project started as a Discord bot but grew to an informational website. My first design was inspired by Bloomberg Terminal, and changed as I actually used the website.",
      },
      ...
      {
        type: "text",
        text: "The aim of this design is to provide valuable information quickly. The main headline summarizes the report in 1 sentence so I have the option to read the full report.",
      },
      {
        type: "image",
