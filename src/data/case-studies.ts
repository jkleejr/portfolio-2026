...
export const caseStudies: Record<string, CaseStudy> = {
  "loot-check": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "I focused on resale, but the app felt the most interesting when I showed it original items like a painting. Since I didn't buy the painting, the app shouldn't display a resale price. This idea expanded the app's function from a price discovery tool for used items to somehow valuing creative work.",
      },
