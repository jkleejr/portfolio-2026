...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "paper-reader": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "If I continued this project, I would integrate an API key into the app, minimize costs, and charge per paper. Since there are many TTS products like Speechify and Blinkist that address similar problems, I ultimately decided to work on new ideas.",
      },
