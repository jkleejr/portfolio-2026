...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      {
        type: "text",
        text: "Buy Side Briefings is a personal website with daily reports on the stock market. The goal is to create a trustworthy source of information that informs the reader on the latest events, and to become my go-to resource.",
      },
      {
        type: "text",
        text: "This project started as notifications from a Discord bot but grew to an informational website. The first design was inspired by Bloomberg Terminal and changed as I actually used the website.",
      },
