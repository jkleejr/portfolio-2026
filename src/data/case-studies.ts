...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "The focus of this design is to provide valuable information quickly. The main headline summarizes the report in 1 sentence so I have the option to read the full report.",
      },
      {
        type: "image",
