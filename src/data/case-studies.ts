...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "paper-reader": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "Since Gemini returns no timings, the app estimates them for highlights. Each sentence takes a % of the group's audio in proportion to its character count. But it drifts slightly.",
      },
