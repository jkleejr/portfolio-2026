...
export const caseStudies: Record<string, CaseStudy> = {
  "loot-check": {
    ...
    blocks: [
       {
        type: "text",
        text: "When I was moving places, I wanted a quick way to find the resale value of an item and decide what to keep or sell. I tried existing apps but they felt poorly designed and required a subscription to use. My solution was a fast, accurate, and free identifying app.",
      },
      ...
      {
        type: "text",
        text: "I focused on resale, but the app was the most interesting when I showed it original items like a painting. Since I didn't buy the painting, I was looking for its potential value. This expanded the app's function as a price discovery tool from used items to include creative work.",
      },
