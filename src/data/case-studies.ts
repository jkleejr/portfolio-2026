...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "buy-side-briefings": {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "This project started as Discord bot notifications and is now an informational website. My first design was inspired by Bloomberg Terminal and changed as I used the website.",
      },
