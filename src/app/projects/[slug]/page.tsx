...
export default async function ProjectPage({ params }: Params) {
  ...
  return (
    // 102px, not a step on the scale, because it is a subtraction rather than
    // a choice: the homepage drops its name 136px from the top, and the title
    // here lands on that same line once the breadcrumb's 26px line and the 8px
    // under it are taken off the front. The breadcrumb goes above it —
    ...
    <main className="pb-8 pt-6 sm:pb-28 sm:pt-[102px]">
      ...
      <div className="mx-auto w-[var(--column)] max-w-[calc(100%-3rem)]">
        ...
        {/* The 8px the date sits under the title, so the three lines — the way
            back, the title, the date — are evenly spaced and read as one block
            rather than as a heading with a label floating over it. Kept in
            step with the mt-2 in case-study.tsx. */}
        <div className="mt-2">
